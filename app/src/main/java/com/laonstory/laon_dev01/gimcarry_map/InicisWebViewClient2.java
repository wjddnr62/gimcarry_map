...
public class InicisWebViewClient2 extends WebViewClient {

    private Activity activity;
    private Context context;

    public InicisWebViewClient2(Activity activity, Context context) {
        ...
        if (!url.startsWith("http://") && !url.startsWith("https://") && !url.startsWith("javascript:")) {
            ...
            try {
                ...
                if (String.valueOf(uri).contains("true")){
                    ((DetailInfoActivity2_airport) context).pay_com();
