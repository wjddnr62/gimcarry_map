...
public class daummapapiActivity extends AppCompatActivity {
    ...
    public void init_webView() {
        ...
        webView.setWebChromeClient(new WebChromeClient(){
            ...
            public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
                WebView newWeb = new WebView(daummapapiActivity.this);
                newWeb.getSettings().setJavaScriptEnabled(true);
                final Dialog dialog = new Dialog(daummapapiActivity.this);
...
//        webView.loadUrl("http://108.160.128.68/daumapi.html");
    }
